...
public class AnswerController {
    ...
    public String createAnswer(Model model, @PathVariable("id") Integer id, @Valid AnswerForm answerForm, BindingResult bindingResult) { // 요청 시 들어가는 데이터는 @RequestParam 으로
        // 답변을 저장할 질문 객체 불러옴
